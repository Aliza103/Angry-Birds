    ...
    fly()
    {
      ...
      display()
      {
        ...
        if (this.sling.bodyA)
        {
          ...
          {
            line(this.sling.bodyA.position.x -10, this.sling.bodyA.position.y, this.sling.pointB.x - 9, this.sling.pointB.y);
          ...
          {
            line(this.sling.bodyA.position.x +25, this.sling.bodyA.position.y, this.sling.pointB.x - 9, this.sling.pointB.y);
